"""
Test restricted asset attachments
"""
...
ASSET_ID = f"{ASSETS_LABEL}/{ASSET_UUID}"
ATTACHMENT_UUID = "abcdef28-0136-4876-ad56-904e12c4b4c6"
ATTACHMENT_ID = f"{ATTACHMENTS_LABEL}/{ATTACHMENT_UUID}"
SUBPATH = (
    f"{ASSETATTACHMENTS_SUBPATH}/{ASSETATTACHMENTS_LABEL}/{ASSET_ID}/{ATTACHMENT_UUID}"
)
RESPONSE = {
    **PROPS,
...
class TestAssetAttachmentsBase(TestCase):
    """
    ...
    def test_assetattachments_str(self):
        ...
        """
        self.assertEqual(
            str(self.arch.assetattachments),
            "AssetAttachmentsClient(url)",
            msg="Incorrect str",
        )


class TestAssetAttachmentsDownload(TestAssetAttachmentsBase):
    """
    ...
    def common_assetattachments_download(
        ...
        with mock.patch.object(self.arch.session, "get") as mock_get:
            ...
            with BytesIO() as fd:
                attachment = self.arch.assetattachments.download(
                    ASSET_ID,
                    ATTACHMENT_ID,
                    fd,
                    params=input_params,
...
class TestAssetAttachmentsInfo(TestAssetAttachmentsBase):
    """
    ...
    def test_assetattachments_info(self):
        ...
        with mock.patch.object(self.arch.session, "get") as mock_get:
            ...
            info = self.arch.assetattachments.info(ASSET_ID, ATTACHMENT_ID)
            args, kwargs = mock_get.call_args
            self.assertEqual(
                args,
